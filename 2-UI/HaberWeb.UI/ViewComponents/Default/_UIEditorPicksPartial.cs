...
{
    public class _UIEditorPicksPartial : ViewComponent
    {
        private readonly IHttpClientFactory _httpClientFactory;

        public _UIEditorPicksPartial(IHttpClientFactory httpClientFactory)
        {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var responserMessage = await client.GetAsync("https://localhost:7187/api/News");
